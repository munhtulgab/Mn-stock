...
const SECTION_GUIDE: Record<string, string> = {
  ...
  dividend_history: `Ногдол Ашгийн Түүх — \`dividend_history\`:
   - Жил бүрийн нэгж хувьцаанд ногдох хэмжээ, өгөөж (yield %) ирнэ. \`year\` нь ашиг олсон жил; \`declarations\` 2 бол тухайн компани хагас жил тутам хуваарилсан бөгөөд дүн нь нийлбэр.
  ...
  combined: `Онооны Задаргаа — \`scored_components_minus100_to_100\`:
   - Энэ апп техник, фундаментал, эрсдэлийн талыг тус тусад нь оноолсон завсрын үр дүн. Эцсийн дүгнэлт БИШ бөгөөд танд эцсийн дүгнэлт өгөгдөхгүй.
   - Дүгнэлтээ өөрөө, анхдагч үзүүлэлтүүдээс гарга. Энэ оноог зөвхөн өөрийн дүгнэлттэйгээ тулгаж, зөрж байвал юунаас болж зөрснийг \`overall_logic\` дотор тайлбарла.

Итгэлцэл (\`signal_confidence\`) тогтоох журам:
   - Итгэлцэл бол "энэ хувьцаа хэр сайн бэ" гэдэг биш, "энэ дүгнэлт хэр бат нотолгоотой вэ" гэдэг хэмжүүр. Гурван зүйлээс гарна:
     (1) НОТОЛГООНЫ ХЭМЖЭЭ — хэдэн хэсэг өгөгдсөн, \`bars\` хангалттай эсэх, утга нь null биш эсэх;
     (2) НОТОЛГООНЫ НИЙЦЭЛ — техник, фундаментал, эрсдэл гурав нэг чиглэл заасан эсэх, 1D/1W/1M гурав нийцэж байгаа эсэх;
     (3) ДОХИОНЫ ХҮЧ — үзүүлэлтүүд хил дээр эсвэл тодорхой хол зайд байгаа эсэх.
   - Гурван талаас хоёр нь зөрчилдвөл итгэлцэл 50-иас доош. Бүх тал нийцэж, өгөгдөл бүрэн бол л 80-аас дээш.
   - Дугуйрсан тоо (80, 85, 90) руу дасаж бүү тат — тооцооноосоо гарсан яг тэр тоог бич.`,
